...
class gsp_grails3_exampleindex_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('message','g',80,['code':("default.link.skip.label"),'default':("Skip to content&hellip;")],-1)
printHtmlPart(6)
expressionOut.print(grails.util.Environment.current.name)
printHtmlPart(7)
expressionOut.print(grailsApplication.config.grails?.profile)
printHtmlPart(8)
invokeTag('meta','g',86,['name':("info.app.version")],-1)
printHtmlPart(9)
invokeTag('meta','g',87,['name':("info.app.grailsVersion")],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1455399241000L
